...
export const metadata: Metadata = {
  ...
  description:
    "Sanish Shrestha is a Computer Engineering student at Khwopa Engineering College, Bhaktapur, building web platforms with Django and React, and experimental systems spanning gesture-driven graphics to bitwise data encoding.",
  openGraph: {
